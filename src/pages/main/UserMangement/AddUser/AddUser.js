...
return(
    <View style={styles.container}>
        <SimpleHeader title="ایجاد کاربر جدید" titleColor={palette.M_3_SYS_ON_SURFACE}backgroundColor={palette.M_3_SYS_ON_PRIMARY}itemsColor={palette.M_3_SYS_ON_SURFACE}/>
        <ScrollView>
            <View style={{marginHorizontal:16}}>
                ...
                <CustomInput label='نام:'placeholder="مثال:سیاورش"required={true}
                             maxLength={20}
                ...
                <CustomInput label='نام خانوادگی:'placeholder="مثال:کسرایی"
                             required={true}
                             maxLength={9}
                             labelColor={palette.M_3_SYS_ON_BACKGROUND}
                             labelStyle={styles.labelStyle}
                ...
                <View style={{marginHorizontal:16}}>
                    <HorizontalSeparator margin={18} />
                </View><CustomInput label='کدهویت کاربری:'placeholder="مثال:شماره استادی/دانشجویی/کارمندی"
                                    required={true}
                                    maxLength={20}
                                    labelColor={palette.M_3_SYS_ON_BACKGROUND}
                                    labelStyle={styles.labelStyle}
                ...
                <View style={{marginHorizontal:16}}>
                    <HorizontalSeparator margin={18} />
                </View><CustomInput label='ایمیل دانشگاهی:'placeholder="مثال:Exaple@Khu.ac.ir"
                                    required={true}
                                    maxLength={20}
                                    labelColor={palette.M_3_SYS_ON_BACKGROUND}
                                    labelStyle={styles.labelStyle}
